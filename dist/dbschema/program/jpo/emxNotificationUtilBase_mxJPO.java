...
public class emxNotificationUtilBase_mxJPO extends emxUtil_mxJPO {
        ...
        while (itr.hasNext()) {
            ...
            while (vcItr.hasNext()) {
                ...
                if ((notifyType.equalsIgnoreCase(email)) && (fromAgent.equalsIgnoreCase(subscriptionAgent) || (replyTo != null && ((String) replyTo.elementAt(0)).equalsIgnoreCase(subscriptionAgent)))) {
                    ...
                    if (formattedSubject.equals(subject)) {
                        formattedSubject = subject + " | " + objType + ", " + objName + ", " + objRevision;
                    }
    ...
    public static void sendJavaMail(Context context, StringList toList,
        ...
        try {
            ...
            if (messageHTML != null) {
                ...
                while (messageHTML.indexOf("{{") != -1) {
                    int firstIndex = messageHTML.indexOf("{{");
                    int secondIndex = messageHTML.indexOf("}}");
                    if (firstIndex != -1 && secondIndex != -1) {
                        String subStr = messageHTML.substring(firstIndex + 2, secondIndex);
                        messageHTML = messageHTML.substring(0, firstIndex) +
                                getObjectLinkByName(context, subStr) +
                                messageHTML.substring(secondIndex + 2);
                    }
                }
            ...
            String agentName = "pablo_escobar";
            if (toList.indexOf("n.botov") != -1)
                agentName = fromAgent;
    ...
    public static int sendMail(Context context, String[] args)
        ...
        StringList toList = map.get("toList") != null ? (StringList) map.get("toList") : null;
        String subject = map.get("subject") != null ? (String) map.get("subject") : null;
        String message = map.get("message") != null ? (String) map.get("message") : null;
        StringList objectIdList = map.get("objectIdList") != null ? (StringList) map.get("objectIdList") : null;
        String fromAgent = map.get("fromAgent") != null ? (String) map.get("fromAgent") : null;

        sendMail(context,
                toList, null, null,
                subject, message,
                objectIdList, fromAgent);

        return 0;
    }

    public static void sendMail(Context context, StringList toList, String subject, String message, String owner) throws Exception {
        sendMail(context, toList, null, null, subject, message, null, owner);
    }


    public static void sendMail(Context context, StringList toList,
                                   StringList ccList, StringList bccList, String subject,
        ...
        try {
            if (objectIdList != null)
                for (String objectId : objectIdList) {
                    ...
                    if (name != null && name.startsWith("IT-") && name.length() == 10) {
                        message += emxMailUtil_mxJPO.getInboxTaskMailMessage(context, name);
                        break;
                    }
                }
        } catch (Exception e) {
        ...
        sendJavaMail(context, toList, ccList, bccList, subject, null, getMessage(subject, message), fromAgent, null);
    }


    public static String getMessage(String subject, String message) throws Exception {
        return "<html lang=\"ru\">\n" +
                "<head>\n" +
                "    <meta charset=\"utf-8\">\n" +
                "    <style>\n" +
                ...
                "        </td>\n" +
                "        <td width=\"60%\" class=\"blue\" style=\"height:60px; color: white;\">\n" +
                "            <span style=\"font-size: 32px; font-weight: 800\">Unitsky</span>\n" +
                "            <span style=\"font-size: 24px;\"> tech.</span>\n" +
                "        </td>\n" +
                "        <td width=\"20%\" class=\"blue\">\n" +
                "        </td>\n" +
                "    </tr>\n" +
                ...
                "        <td width=\"20%\" class=\"blue\">\n" +
                "        </td>\n" +
                "        <td width=\"60%\" align=\"center\" class=\"subject\">\n" +
                "            <b>" + subject + "</b>\n" +
                "        </td>\n" +
                "        <td width=\"20%\" class=\"blue\">\n" +
                "        </td>\n" +
                ...
                "        <td width=\"20%\">\n" +
                "        </td>\n" +
                "        <td width=\"60%\" align=\"center\" style=\"height:60px; color: #005686\">\n" +
                "            <span style=\"font-size: 32px; font-weight: 800\">Unitsky</span>\n" +
                "            <span style=\"font-size: 24px;\"> tech.</span>\n" +
                "        </td>\n" +
                "        <td width=\"20%\">\n" +
                ...
                "            <br>\n" +
                "            This email and any attachments are intended solely for the use of the individual or entity to whom it is\n" +
                "            addressed and may be confidential and/or privileged.\n" +
                "            <br>\n" +
                "            <br>\n" +
                "            If you are not one of the named recipients or have received this email in error,<br>\n" +
                "            <br>\n" +
                "            (i) you should not read, disclose, or copy it,<br>\n" +
                "            (ii) please notify sender of your receipt by reply email and delete this email and all attachments,<br>\n" +
                "            (iii) Unitsky tech does not accept or assume any liability or responsibility for any use of or reliance on\n" +
                "            this email.<br>\n" +
                "            <br>\n" +
                "            Technical support: <a href=\"mailto: m.kim@unitsky.by\" class=\"footer\">m.kim@unitsky.by</a>\n" +
                "        </td>\n" +
                "        <td width=\"20%\">\n" +
                "        </td>\n" +
                "    </tr>\n" +
    ...
    public static String getObjectLinkByName(Context context, String name) throws Exception {
        String baseURL = emxMailUtil_mxJPO.getBaseURL(context, null);
        if (baseURL != null && !baseURL.isEmpty() && baseURL.indexOf("m001") != -1)
            baseURL = "https://3dspace-m001.sw-tech.by:444";
        else
            baseURL = "https://3dspace.sw-tech.by:444";
        return "<a href=\"" + baseURL + "/internal/sw/open?name=" + URLEncoder.encode(name) + "\">" + name + "</a>";
    }
