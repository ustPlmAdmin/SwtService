            ...
            while (bGreaterSeqNoFound == 1) {
                ...
                for (int i = 0; i < nRoutedNodeObjectsSize; i++) {
                    ...
                    if (routeSequence == sRouteSequenceValue) {
                        ...
                        ;
                        if ("Inactive".equals(currentState) && !isKindOfProxyGroup) {
                        ...
                        if (mlOldTasks.size() > 0) {
                            ...
                            if (POLICY_INBOX_TASK_STATE_COMPLETE
                                ...
                                try {
                                    ...
                                    sInboxTaskId = (String) dmoNewTask.getInfo(context, slTaskSelect).get(DomainObject.SELECT_ID);
                            ...
                            if ("true".equalsIgnoreCase(sRoutePreserveOwner) && UIUtil.isNotNullAndNotEmpty(strTaskAssignTo)) {
                                ...
                                DomainRelationship rel = DomainRelationship.connect(context, Route, DomainConstants.RELATIONSHIP_ROUTE_NODE, person);
                                rel.setAttributeValues(context, relAttrs);
                                newRelId = rel.getName();
                                sRouteNodeId = newRelId;
                                newRelId = MqlUtil.mqlCommand(context, "print connection $1 select $2 dump", newRelId, "physicalid");
...
//                      # 370487 set the originator value of task
                        ...
                        if ((sRPEType.equals(sInboxTaskType))
                            ...
                            sendMailNotificationIfTask(context, user, sPersonName, sRPEType, sRPEName, sRPERev,
                                    sGroupOrRoleTitle, sGRName, sRPEOwner, sInboxTaskId, sInboxTaskType, sInboxTaskName,
                                    sInboxTaskRev, sRouteObjects, sRoleOrGroupToList, sType, sName, sRev, sTreeMenu,
                                    mailUtil, sRouteOwner);
                            ...
                            sendMailNotificationIfRoute(context, user, sScheduledCompletionDate, sRouteInstructions,
                                    ...
                                    sName, sRev, sTreeMenu, mailUtil, sRouteOwner, strTranslatedInboxTaskType,
                                    strTranslatedSType, strTranslatedRouteAction, tenantId);
                        }
                            ...
                            if (isKindOfProxyGroup) {
                                ...
                                if (sRouteObjects.equals("")) {
                                    ...
                                    if (sDelegatorId.equals("")) {
                                        ...
                                        String[] messageValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, strTranslatedRPEType, sRPEName, sRPERev, sRPEOwner, sType, sName, sRev, sRouteOwner};
                                        ...
                                        Map payload = new HashMap();
                                        String messageKey = "emxFramework.ProgramObject.eServicecommonInitiateRoute.DelegatorMessageNotice";
                                        payload.put("message", messageKey);

                                        String[] messageKeys = {"IBType", "IBName", "IBRev", "RPEType", "RPEName", "RPERev", "RPEOwner", "Type", "Name", "Rev", "ROwner", "Delegator"};
                                        payload.put("messageKeys", messageKeys);

                                        String[] messageHTMLValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, strTranslatedRPEType, sRPEName, sRPERev, sRPEOwner, sType, sName, sRev, sRouteOwner, sPersonFirstName + " "
                                                + sPersonLastName};
                                        payload.put("messageValues", messageHTMLValues);
                                        ...
                                        String[] messageTextValues = {strTranslatedInboxTaskType, taskNameLink, sInboxTaskRev, strTranslatedRPEType, sRPEName, sRPERev, sRPEOwner, sType, routeNameLink, sRev, sRouteOwner, sPersonFirstName + " "
                                                + sPersonLastName};
                                        ...
                                        Map arg = new HashMap();
                                        arg.put("payload", payload);
                                        arg.put("bundleName", basePropName);
                                        arg.put("locale", context.getLocale());
                                        ...
                                        String messageText = MessageUtil.getMessage(context, null, messageKey, messageKeys, messageTextValues, null, context.getLocale(), basePropName);
                                        String htmlMessage = (String) JPO.invoke(context, "emxInboxTaskNotificationBase", null, "getMessageHTML", JPO.packArgs(arg), String.class);
                                        String oldAgentName = mailUtil.getAgentName(context, new String[]{});

                                        mailUtil.setAgentName(context, new String[]{user});
                                        emxNotificationUtil_mxJPO.sendJavaMail(context, toList, null, null, subject, null, htmlMessage, null, toList, null, "email");
                                        emxNotificationUtil_mxJPO.sendJavaMail(context, toList, null, null, subject, messageText, null, null, toList, null, "iconMail");
                                        mailUtil.setAgentName(context, new String[]{oldAgentName});
                                    ...
                                    if (sDelegatorId.equals("")) {
                                        ...
                                        String strInboxDueDate = inboxTask.getInfo(context, "attribute[" + sAttScheduledCompletionDate + "]");
                                        String[] messageValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, strTranslatedSType, sName, sRev,
                                        ...
                                        String sInboxTaskLink = emxNotificationUtil_mxJPO.getObjectLinkHTML(context, sInboxTaskName, sInboxTaskId);
                                        String sRouteLink = emxNotificationUtil_mxJPO.getObjectLinkHTML(context, sName, sRouteId);
                                        String[] tableValues = {strTranslatedRouteAction, sRouteLink, sInboxTaskLink, strInboxDueDate, sRouteInstructions, sRouteContent, sRouteContentDescription};
                            ...
                            if (isKindOfProxyGroup) {
                                ...
                                if (sRouteObjects.equals("")) {
                                    ...
                                    if (sDelegatorId.equals("")) {
                                        ...
                                        String[] messageValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, strTranslatedSType, sName, sRev, sRouteOwner};
                                        payload.put("messageKeys", messageKeys);
                                        payload.put("messageValues", messageValues);
                                        payload.put("tableHeader", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableHeader");
                                        payload.put("tableRow", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableData");
                        ...
                        if (!sDelegatorId.equals("")) {
                            ...
                            mailUtil.setAgentName(context, new String[]{user});
                            emxNotificationUtil_mxJPO.sendJavaMail(context, toList, null, null, subject, messageText, null, null, toList, null, "email");
                            emxNotificationUtil_mxJPO.sendJavaMail(context, toList, null, null, subject, messageText1, null, null, toList, null, "iconMail");
                            mailUtil.setAgentName(context, new String[]{oldAgentName});
                        }
                    }
    ...
    private static void sendMailNotificationIfRoute(Context context, String user, String sScheduledCompletionDate,
                                                    ...
                                                    String[] sTreeMenu, emxMailUtil_mxJPO mailUtil, String sRouteOwner, String strTranslatedInboxTaskType,
                                                    String strTranslatedSType, String strTranslatedRouteAction, String tenantId) throws Exception {
        if (sRouteObjects.equals("")) {
            ...
            String[] messageValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, sGRName, strTranslatedSType, sName, sRev, sRouteOwner};
            payload.put("messageKeys", messageKeys);
            payload.put("messageValues", messageValues);
            payload.put("tableHeader", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableHeader");
            payload.put("tableRow", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableData");
            ...
            String[] messageValues = {strTranslatedInboxTaskType, sInboxTaskName, sInboxTaskRev, sGRName, strTranslatedSType, sName, sRev, sRouteOwner, sRouteObjects};
            payload.put("messageKeys", messageKeys);
            payload.put("messageValues", messageValues);
            payload.put("tableHeader", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableHeader");
            payload.put("tableRow", "emxFramework.ProgramObject.eServicecommonInitiateRoute.TableData");
    ...
    private static void sendMailNotificationIfTask(Context context, String user, String sPersonName, String sRPEType,
                                                   String sRPEName, String sRPERev, String sGroupOrRoleTitle, String sGRName, String sRPEOwner,
                                                   ...
                                                   String[] sTreeMenu, emxMailUtil_mxJPO mailUtil, String sRouteOwner) throws Exception {
        if (sRouteObjects.equals("")) {
