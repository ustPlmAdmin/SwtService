define("DS/SWTSpecExcel/controller", ['DS/SWTUtils/api', "DS/ENO6WPlugins/jQuery"], function (api, $) {
    return function () {
        ...
        $("#export").on("click", function () {
            ...
            api.download(objectName + ".xls", "spec_schema_xls", {name: objectName}, function () {
