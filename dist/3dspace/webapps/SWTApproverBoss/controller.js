define("DS/SWTApproverBoss/controller", ["DS/SWTUtils/api", "DS/ENO6WPlugins/jQuery", "DS/SWTUtils/ui"], function (api, $, ui) {
    return function () {
        ...
        api.getJson("approve_boss_list", {}, function (data) {
            ...
            ui.table("members", ["route_name", "task_name", "task_originated","task_finish", "task_assigner", "task_comment", "ca_name", "ca_owner"], data.routesMembers);
        })
    }
});