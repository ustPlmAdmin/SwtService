 ...
 */
public class SpecComp extends SpecUtils {
...
//                sortSeq.add("OtherComponents");
    ...
    void addTitles(Sheet sheet, Map<String, CellStyle> styles) {
        ...
        addCell(row, COLS.CODE.ordinal(), "Шифр детали", styles.get("header"));
    ...
    AddRowResult addRow(HttpServletRequest request, Context ctx, Sheet sheet, Map<String, Object> item, Integer level,
        ...
        Map<String, String> obj = findObject(ctx, "*", (String) item.get("name"), "attribute[PLMEntity.V_Name]:title",
                ...
                "current",
                "owner",
                "attribute[WCGEquivalentDeclaredWeightExt.V_WCG_Declared_Mass]:mass_declared",
                "attribute[WCGEquivalentComputedExt.V_WCG_Mass]:mass_computed");
        ...
        if (visible && mode.equals("only_1level") && level != 1) // or 2nd half of this?  !obj.get("spec_type").equals("Assemblies")
            visible = false;
        ...
        if (visible) {
            ...
            addCell(row, COLS.CODE.ordinal(), !(obj.get("spec_type").equals("StandardComponents") || obj.get("title").equals("") )? obj.get("title") + " " + obj.get("description") : obj.get("description"), style); // стандарт/покупные
            ...
            if (!mode.equals("ute")) {
                ...
                for (String drwId : findRowsList(ctx, "*", (String) item.get("name"), "from[VPMRepInstance].to.id")) {
                    ...
                    if ((!mode.equals("all") && drw.get("type").equals("3DShape")) || mode.equals("only_1level"))
                        continue;
